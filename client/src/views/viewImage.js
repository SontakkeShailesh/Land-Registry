  ...
  componentDidMount = async () => {
    ...
    try {
      ...
      for (var i = 1; i < count + 1; i++) {
        ...
        rowsSt.push(<ContractData contract="Land" method="getStatus" methodArgs={[i, { from: "0x113bcBEE8254c6C44a1bb1F3A338315128cdD6Fe" }]} />);
        ...
        // rowsIpfs.push((<ContractData contract="Land" method="getImage"  methodArgs={[i, { from: "0x113bcBEE8254c6C44a1bb1F3A338315128cdD6Fe" }]} />));
      }
